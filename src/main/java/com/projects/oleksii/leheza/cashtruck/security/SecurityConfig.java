...
import com.projects.oleksii.leheza.cashtruck.filter.JwtAuthenticationFilter;
import com.projects.oleksii.leheza.cashtruck.filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter  {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(GET, "/api/user/**").hasAuthority("ROLE_CLIENT");
